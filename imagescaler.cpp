...
RET_CODE ImageScaler::Init(uint32_t src_width, uint32_t src_height,
                           int src_pix_fmt, uint32_t dst_width, uint32_t dst_height
                           , int dst_pix_fmt, SwsAlogrithm en_alogrithm) {

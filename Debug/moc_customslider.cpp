...
QT_MOC_LITERAL(1, 13, 27), // "SigCustomSliderValueChanged"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 5) // "value"

    },
    "CustomSlider\0SigCustomSliderValueChanged\0"
    "\0value"
};
...
void CustomSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SigCustomSliderValueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomSlider::SigCustomSliderValueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomSlider::SigCustomSliderValueChanged(int _t1)
{

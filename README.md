...
- 播放/暂停
- 上一/下一视频
- 变速播放[使用sonic进行音频倍速播放_使用sonic库处理音频-CSDN博客](https://blog.csdn.net/qq_40170041/article/details/127727153?ops_request_misc=%7B%22request%5Fid%22%3A%2279115751-E262-4FE3-9413-9FD4C1D984AD%22%2C%22scm%22%3A%2220140713.130102334..%22%7D&request_id=79115751-E262-4FE3-9413-9FD4C1D984AD&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduend~default-1-127727153-null-null.142^v100^pc_search_result_base9&utm_term=sonic库&spm=1018.2226.3001.4187)

  ```
  sonic
  创建sonicCreateStream(is->get_target_frequency(),is->get_target_channels());
   // 设置变速系数
